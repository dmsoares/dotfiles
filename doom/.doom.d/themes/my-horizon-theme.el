...
;;; my-horizon-theme.el -*- lexical-binding: t; no-byte-compile: t; -*-

;;; doom-horizon-theme.el --- Inspired by VSCode Horizon
...
(def-doom-theme my-horizon
  ...
  (((font-lock-comment-face &override)
   ...
   ((line-number &override) :foreground "#D3D3D3")
